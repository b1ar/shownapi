...
declare class TActor {
	...
	Damage: ( ATarget: TActor,AValue: number,MagicID?: number,MagicLevel?: number) =>  void;
	DamageDelay: ( ATarget: TActor,AValue: number,Delay: number,MagicID?: number,MagicLevel?: number) =>  void;
	...
	ShowBleedNumber(TemplateID: number,BleedNumber: number): void;
...
declare class TPlayObject extends TActor {
	...
	SendBleedNumber(BleedActor: TActor,TemplateID: number,BleedNumber: number): void;
